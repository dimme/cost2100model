function [paraEx paraSt] = get_para(network,freq,snapRate, snapNum, posBS,posMS,veloMS,antBS,antMS)
...
% .ant_BS: BS ant. array info. ['antFileName',azi. rotation, ele. rotation]
% .ant_MS: MS ant. array info. ['antFileName',azi. rotation, ele. rotation]
...
% .band: bandwidth 'narr'/'wide' for narrow-/wide-band communication
...
paraEx.pos_BS = posBS; %Position of BSs
paraEx.pos_MS = posMS; %Position of MSs
paraEx.velo_MS = veloMS; %Velo of MSs
paraEx.ant_BS = antBS; %Ant. array info. of BSs
paraEx.ant_MS = antMS; %Ant. array info. of MSs
...
paraEx.overSample=4; %Over-sampling rate of the channels
paraEx.band='wide'; %'narr'/'wide': Narrowband or Wideband channel
...
%         paraSt.l_theta_MS = --;
    ...
    %%%%%%%%%%%%%%%%        
        ...
        %For multi-link extension
        paraSt.BS_common = [0.5 0.5]; %BS-common cluster ratio to total number of clusters (1,2,3,...)
        paraSt.MS_common = 4; %Average number of VRs in VR group for one MS-common cluster
